...
class ControllerPublisher(Node):
    ...
    def joystick_callback(self):
        ...
        linear_velocity_Y = -linear_axis_Y *  0.2  # Adjust scale as needed
        linear_velocity_X = linear_axis_X *   0.2  # Adjust scale as needed
        angular_velocity_Z = angular_axis_Z * 0.2
